const Directors = [{
    _id: {ObjectId:(1001)},
      ...
      Death: "N/A",
      ImagePath: "SamWeisman.png",
    Featured: true,
    Movies: [{ _id:{ObjectId:(2011), Title: "George of the Jungle", Genre: 'Comedy', Rating: 'PG'}}]
},
{
    _id: {ObjectId:(1002)},
      Name: "Mel Gibson",
    ...
    Featured: true,
    Movies: [{ _id: {ObjectId:(2004), Title: "Braveheart", Genre: 'Drama', Rating: 'R'}},
    { _id: {ObjectId:(2003), Title: "Passion of the Christ", Genre: 'Drama', Rating: 'R'}},
...
},
{
    _id: {ObjectId:(1003)},
      ...
      Death: "N/A",
    ImagePath: "JonFavreau.png",
    Featured: false,
    Movies: [{ _id: {ObjectId:(2002), Title: "Ironman", Genre: 'Action', Rating: 'PG-13'}}]
  },
{
    _id: {ObjectId:(1004)},
      Name: "James Gunn",
...
},
{
    _id: {ObjectId:(1006)},
      ...
      Death: "N/A",
    ImagePath: "JohnLasseter.png",
    Featured: false,
    Movies: [{ _id: {ObjectId:(2005), Title: "Toy Story", Genre: 'Animation', Rating: 'G'}}]
},
{
    _id: {ObjectId:(1007)},
      ...
      Birth: "May 21, 1959",
      Death: "N/A",
    ImagePath: "NickCass.png",
    Featured: false,
    Movies: [{ _id: {ObjectId:(2009), Title: "The Notebook", Genre: 'Romance', Rating: 'R'}}]
},
{
    _id: {ObjectId:(1008)},
      Name: "Lana Wachowski",
      ...
      Birth: "June 21, 1965",
      Death: "N/A",
    ImagePath: "LanaWachowski.png",
    Featured: true,
    Movies: [{ _id: {ObjectId:(2010), Title: "The Matrix", Genre: 'Action', Rating: 'R'}},
            { _id: {ObjectId:(2044), Title: "The Matrix Reloaded", Genre: 'Action', Rating: 'R'}}]
},
{
    _id: {ObjectId:(2009)},
      Name: "Sam Raimi",
      ...
      Death: "N/A",
    ImagePath: "SamRaimi.png",
    Featured: false,
    Movies: [{ _id: {ObjectId:(2008), Title: "SpiderMan", Genre: 'Action', Rating: 'R'}}]
},
{
    _id: {ObjectId:(1010)},
    Name: "Frank Darabont",
...
},
{
  ...
  Birth: "1968-04-17",
  Death: "N/A",
  ImagePath: "AdamMckay.png",
Featured: false,
Movies: [ {_id: {ObjectId:(2030)}, Title: "Talladega Nights: The Ballad of Ricky Bobby", Genre: 'Comedy', Rating: "PG-13"},
          {_id: {ObjectId:(2031)}, Title: "The Big Short", Genre: 'Drama', Rating: "R"},
          {_id: {ObjectId:(2032)}, Title: "The Other Guys", Genre: 'Comedy', Rating: "R"},
          {_id: {ObjectId:(2035)}, Title: "Anchorman: The Legend of Ron Burgundy", Genre: 'Comedy', Rating: "PG-13"},
          {_id: {ObjectId:(2033)}, Title: "Anchorman 2: The Legend Continues", Genre: 'Comedy', Rating: "PG-13"},
          {_id: {ObjectId:(2034)}, Title: "Step Brothers", Genre: 'Comedy', Rating: "PG-13"}]
},
{
  _id: {ObjectId:(1015)},
  ...
  Birth: "1963-03-27",
  Death: "N/A",
  ImagePath: "QuentinTarantino.png",
Featured: true,
Movies: [ {_id: {ObjectId:(2035)}, Title: "Pulp Fiction", Genre: 'Drama', Rating: "R"},
          {_id: {ObjectId:(2036)}, Title: "The Hateful Eight", Genre: 'Drama', Rating: "R"},
          {_id: {ObjectId:(2037)}, Title: "Reservoir Dogs", Genre: 'Drama', Rating: "R"},
...
},
{
  ...
  Birth: "1964-05-23",
  Death: "N/A",
  ImagePath: "JossWhedon.png",
Featured: false,
Movies: [ {_id: {ObjectId:(2043)}, Title: "The Avengers", Genre: 'Action', Rating: "R"}]
},
{
  _id: {ObjectId:(1017)},
  ...
  Birth: "1970-07-30",
  Death: "N/A",
  ImagePath: "ChristopherNolan.png",
Featured: true,
Movies: [ {_id: {ObjectId:(2045)}, Title: "Inception", Genre: 'Action', Rating: "PG-13"},
          {_id: {ObjectId:(2046)}, Title: "Interstellar", Genre: 'Drama', Rating: "PG-13"},
          {_id: {ObjectId:(2047)}, Title: "Dunkirk", Genre: 'Drama', Rating: "PG-13"},
          {_id: {ObjectId:(2048)}, Title: "Batman Begins", Genre: 'Action', Rating: "PG-13"},
          {_id: {ObjectId:(2049)}, Title: "The Dark Knight", Genre: 'Action', Rating: "PG-13"},
          {_id: {ObjectId:(2050)}, Title: "The Dark Knight Rises", Genre: 'Action', Rating: "PG-13"}]
},
{
  _id: {ObjectId:(1018)},
  ...
  Birth: "1942-11-17",
  Death: "N/A",
  ImagePath: "MartinScorsese.png",
Featured: true,
Movies: [ {_id: {ObjectId:(2050)}, Title: "The Irishman", Genre: 'Drama', Rating: "R"},
          {_id: {ObjectId:(2051)}, Title: "The Wolf of Wallstreet", Genre: 'Comedy', Rating: "R"}]
},
{
  _id: {ObjectId:(1019)},
  ...
  Birth: "1967-10-03",
  Death: "N/A",
  ImagePath: "DenisVilleneuve.png",
Featured: false,
Movies: [ {_id: {ObjectId:(2052)}, Title: "Blade Runner 2049", Genre: 'Action', Rating: "R"}]
},
{
  _id: {ObjectId:(1020)},
  Name: "Ridley Scott",
  ...
  Birth: "1937-11-30",
  Death: "N/A",
  ImagePath: "RidleyScott.png",
Featured: true,
Movies: [ {_id: {ObjectId:(2054)}, Title: "Gladiator", Genre: 'Drama', Rating: "R"},
          {_id: {ObjectId:(2055)}, Title: "Hannibal", Genre: 'Drama', Rating: "R"},
          {_id: {ObjectId:(2056)}, Title: "American Gangster", Genre: 'Crime', Rating: "R"},]
}
]
